...
// GY-87 (MPU6050 + HMC5883L + BMP180) - Telemetria completa por puerto serial
// El modulo trae 3 sensores en un mismo I2C:
//  - MPU6050 (0x68): acelerometro + giroscopio
//  - HMC5883L (0x1E): magnetometro, colgado del bus AUX del MPU6050.
//    Se accede activando el modo bypass del MPU6050.
//  - BMP180 (0x77): barometro (presion, temperatura, altitud), en el bus principal.
// Todo se implementa a registros crudos, sin librerias externas.
...
void setup()
{
  ...
  Serial.println("GY-87 listo: MPU6050 + HMC5883L + BMP180");
}
...
void loop()
{
  ...
  if (magOk)
  {
    Serial.printf("MAG  | X:%d Y:%d Z:%d (raw) | Heading: %.1f deg\n",
